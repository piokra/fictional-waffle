...
\end{definicja}
Istnienie takiej klasy procesów pokazano w \cite{causal_model}. Przykładem takiego procesu jest 
...
\begin{definicja}
Świadkiem przyczynowości nazywa się taki operator S, dla którego dla każdej macierzy separowalnej $W^{sep}$ spełniona jest nierówność:
\begin{equation}
